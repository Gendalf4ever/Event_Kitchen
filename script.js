...
const formats = [
    {
        ...
        desc: "Неформальная встреча с кулинарным мастер-классом или готовкой ужина вместе",
    ...
    },
    {
        ...
        desc: "Тематическая вечеринка перед свадьбой с кулинарным развлечением",
        image: "formats/bachelor-party.jpg",
        details: "Альтернатива традиционному девичнику или мальчишнику. Готовим вместе, смеёмся, общаемся в неформальной обстановке. Можно заказать тематическое меню, декорации и дополнительные развлечения."
    },
    {
        title: "День рождения взрослый",
        desc: "Празднование дня рождения с кулинарным мастер-классом для гостей",
        image: "formats/birthday.jpg",
    ...
    },
    {
        ...
        image: "formats/family.jpg",
        details: "Отличная идея для выходного дня — всей семьёй приготовить что-то вкусное. Подходит для детей от 5 лет. Учимся работать в команде, осваиваем кулинарные навыки и весело проводим время вместе."
    },
    {
    ...
    },
    {
        ...
        desc: "Обучение конкретным кулинарным техникам и рецептам",
        image: "formats/masterclass.jpg",
...
const faqItems = [
    ...
    },
    {
        ...
        answer: "Наше пространство комфортно вмещает до 25 человек для мероприятий в формате фуршета и до 15 человек для мероприятий с посадкой за общим столом. Для детских праздников рекомендуем группы до 12 детей."
    },
    {
